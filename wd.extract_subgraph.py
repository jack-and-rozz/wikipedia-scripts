...
@timewatch
def main(args):
  items_fh = "%s/%s" % (args.source_dir, 'items')
  props_fh = "%s/%s" % (args.source_dir, 'properties')
  triples_fh = "%s/%s" % (args.source_dir, 'triples')
  print '----------------------'
  ...
  items_fh = "%s/%s" % (target_dir, 'items')
  props_fh = "%s/%s" % (target_dir, 'properties')
  triples_fh = "%s/%s" % (target_dir, 'triples')
  @timewatch
  def dump():
    pickle.dump(items, open(items_fh + ".bin", 'wb'))
    pickle.dump(props, open(props_fh + ".bin", 'wb'))
    pickle.dump(triples, open(triples_fh + ".bin", 'wb'))
